import { type FormItemCustomType, registerCustomType } from '@/store/form-item-custom-type';
...
export function registerFormItemCustomTypes() {
    for (const customType of customTypes) {
        registerCustomType(customType);
    }
}
